        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmCurso = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Alugueres_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Alugueres_Clientes_ClienteId",
                        column: x => x.ClienteId,
                        principalTable: "Clientes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Alugueres_Livros_LivroId",
                        column: x => x.LivroId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Alugueres_LivroId",
                table: "Alugueres",
                column: "LivroId");

            migrationBuilder.CreateIndex(
                name: "IX_Alugueres_UsuarioId",
                table: "Alugueres",
                column: "UsuarioId");
